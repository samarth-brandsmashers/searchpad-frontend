    ...
    <div className={styles.container}>
      <nav className={styles.sidebar}>
       ...
       <Image src={forwordicon} style={{ width: '15px', height: '15px' }} alt='forword icon ' className={styles.forwordicon}/>
        ...
        <li className={styles.listItem}><Image src={myinspretion}/> Creations</li>
      ...
      <IoIosArrowDown className="downicon" />
          ...
          <li className={styles.listItem}><Image src={videocreation}/>Video Creation</li>

          <li className={styles.listItem}><Image src={mic}/>Voiceover</li>

          <li  className={styles.listItem}><Image src={ideas}/>Idea Generation</li>
        ...
        Data & Visualization
          ...
          <li className={styles.listItem}><Image src={adcreatives}/>Ad Creative</li>

          <li className={styles.listItem}><Image src={webdesign}/>Website UI</li>

          <li className={styles.listItem}><Image src={slide}/>Slide Creation</li>

          <li className={styles.listItem}><Image src={chartrose }/>Data VisualiZation</li>
        </ul>
    ...
    <Image src={robot} alt="robo" width={342} height={342} />
        ...
        <h2 className={styles.headings}> Create stunning designs, documents, and data visualizations—AI makes it easy.</h2>
          <div className={styles.toolsContainer}>
            ...
            <div className={styles.toolCard}><Image src={videoCreation} className={styles.toolsimage}/>
            <h1 className={styles.design}>Video Creation</h1></div>
            <div className={styles.toolCard}><Image src={adCreation} className={styles.toolsimage}/>
            <h1 className={styles.design}>Ad Creative</h1></div>
            <div className={styles.toolCard}><Image src={visualization} className={styles.toolsimage}/>
            <h1 className={styles.design}>Design & Visualization</h1></div>
            <div className={styles.toolCard}><Image src={ voiceover} className={styles.toolsimage}/>
            <h1 className={styles.design}>Voiceover</h1></div>
            <div className={styles.toolCard}><Image src={idea} className={styles.toolsimage}/>
            <h1 className={styles.design}>Idea Generation</h1></div>
            <div className={styles.toolCard}><Image src={ documents } className={styles.toolsimage}/>
            <h1 className={styles.design}>Document Creation</h1></div>
          </div>
        </section>
