    ...
    <>
      <div className={styles.mainHead}>
        <div className={styles.logo}>
          <Image
            src="/logo.png" // Replace this with the actual path to your image
            alt="Logo"
            width={159.03} // Set the desired width of the image
            height={58.29} // Set the desired height of the image
            layout="responsive"
          />
        </div>
